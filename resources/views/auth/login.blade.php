                    ...
                    <div class="card-body">
                        <div class="mb-3">
                                ...
                                <div class="d-grid gap-2 col-8 mx-auto">
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-8 px-0">
                                            <input type="text" name="email" class="form-control" id="email" value="admin@example.com">
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="password" class="col-sm-4 col-form-label px-0">Password</label>
                                        <div class="col-sm-8 px-0">
                                            <input type="password" name="password" class="form-control" id="password" value="Test123">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="d-grid gap-2 col-8 mx-auto">
                                ...
                                {{-- <a href="{{ route('facebook.login') }}" class="btn btn-outline-primary me-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16"><path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"></path></svg>
                                    Facebook
                                </a> --}}
                                <a href="{{ route('github.login') }}" class="btn btn-outline-dark">
